...
function generateRandomOrder() {
  ...
  var amount = (Math.random() * (400.99 - 20.00) + 20.00).toFixed(2); // Génère un montant aléatoire entre $20,00 et $400,99
  return 'You have a new order for ' + items + ' item' + (items > 1 ? 's' : '') + ' totaling $' + amount;
}
